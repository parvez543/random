...
tryFree.addEventListener('click', function () {
  document.querySelector('.howItWorksContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/Mesh-BG1.svg')";
  document.querySelector('.processContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/Mesh-1.svg')";
...
getButton.addEventListener('click', function () {
  document.querySelector('.howItWorksContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/getStart.svg')";
  document.querySelector('.processContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/getQuoteBg.svg')";
...
placeOrder.addEventListener('click', function () {
  document.querySelector('.howItWorksContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/customOrder.svg')";
  document.querySelector('.processContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/customOrderBg.svg')";
...
customOrder.addEventListener('click', function () {
  document.querySelector('.howItWorksContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/placeOrderBg.svg')";
  document.querySelector('.processContainer').style.backgroundImage = "url('./assets/images/HomePage/howItWorks/placeOrderBack.svg')";
  document.getElementById('tryFreeContainer').style.background = "rgba(255, 255, 255, 0.3)"
  document.getElementById('getQuote').style.background = "rgba(255, 255, 255, 0.3)"
  document.getElementById('placeOrder').style.backgroundColor = 'rgba(255, 255, 255, 0.3)'
...
firstStep.addEventListener('click', () => {
  document.querySelector(".tryUsFreeButton").style.backgroundImage = "1px solid url('./assets/images/HomePage/howItWorks/Stock.svg')"
});

document.querySelector('.tryUsFreeContainer').style.backgroundImage = 'url("./assets/images/HomePage/howItWorks/Stock.svg")';
...
getQuoteBorder.addEventListener('click', () => {
  ...
  document.querySelector(".getQuoteContainer").style.backgroundImage = 'url("./assets/images/HomePage/howItWorks/get_quote.svg")';
...
placeOrderContent.addEventListener('click', () => {
  ...
  document.querySelector('.placeOrderContainer').style.backgroundImage = 'url("./assets/images/HomePage/howItWorks/get_quote.svg")'
...
customOrderContentStep.addEventListener('click', () => {
  ...
  document.querySelector('.customContainer').style.backgroundImage = 'url("./assets/images/HomePage/howItWorks/last.svg")'
